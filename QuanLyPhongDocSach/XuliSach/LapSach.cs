...
Primary.BlueGrey500, Accent.LightBlue200, TextShade.WHITE);
		...
		private void button_CapNhatThe_Click(object sender, EventArgs e) {
			if (CheckInfo()) {
				...
				sach.TheLoai = new DataAccess.DataObject.TheLoai() { TenTheLoai = comboBox_theloai.Text };
				...
				sach.TacGia = new DataAccess.DataObject.TacGia() { TenTacGia = comboBox_tacgia.Text };
